...
def augmentation_pytorch_only_image(x, imsize=256, trans_threshold=0.0, horizontal_flip=None, rotation_range=None,
...
def augment_image_label_class(x, y, z, imsize=256, trans_threshold=0.0, horizontal_flip=None, rotation_range=None,
                              height_shift_range=None, width_shift_range=None, shear_range=None, zoom_range=None,
    ...
    if temp2 < trans_threshold:
        ...
        if elastic is not None:
            if np.random.random() < trans_threshold:
                x, y, z = elastic_transform1(x.reshape(imsize, imsize), y.reshape(imsize, imsize),
                                             z.reshape(imsize, imsize), *elastic)
